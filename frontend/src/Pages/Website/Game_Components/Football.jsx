...
const Football = () => {
    ...
    const matches = [
        { name: "Melbourne Victory v Sydney FC / 24/01/2025 13:05:00", },
        // { name: "Twenty20 Big Bash / 14/12/2024 13:45:00", },
        // { name: "Kerala v Madhya Pradesh / 23/01/2025 09:30:00", },
        // { name: "Mumbai v Jammu and Kashmir / 23/01/2025 09:30:00", },
        // { name: "TKR XI v SLZ XI / 24/01/2025 12:15:00", }
    ];
    console.log(matches);
    return (
        <div className='bg-[#f2f2f2] h-[600px] ml-[7px]  mr-[6px] mt-[12px] font-roboto flex '>
            ...
            <div className='w-full'>
                ...
                <div className='grid grid-cols-12 bg-[#F7F7F7]'>
                    ...
                    <div className='font-semibold text-[19.111px] pt-[6.1px] mb-[6px] pl-[6.1px]  tracking-custom col-span-7 '>
                        <p className=''>Game</p>
                    </div>
                    ...
                    <div key={index}>
                        <div className=' items-center grid grid-cols-12 '>
                            ...
                            <div className='col-span-5 text-[#2c3e50]'>
                                <p className='text-[18.75px] my-[1.25px] pl-[6.1px] tracking-customTight1 '>{item.name}</p>
                            </div>
